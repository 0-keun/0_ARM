...
end_desired = [0.14,0]
theta = dofbot.calculate_desired_joints_opened(end_desired)
move_to(theta,1500)
...
end_desired = [0.14,0.05]
theta = dofbot.calculate_desired_joints_closed(end_desired) 
move_to(theta,1500)

end_desired = [0.08,0.05]
theta = dofbot.calculate_desired_joints_closed(end_desired)
move_to(theta,1500)
